...
const cacheName = 'team1AProjectFa20-2021-03-31 22:57:29.037676'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'team1AProjectFa20'.length) === 'team1AProjectFa20') {
